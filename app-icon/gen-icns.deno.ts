 ...
 * 1. Generate macOS ICNS variants from the committed hand-designed PNG sources.
 * 2. Preserve standard macOS canvas padding while producing every required iconset size.
 * 3. Support explicit input/output paths and guarded batch conversion from the current directory.
 *
 * Original request (2026-07-31): "左侧导航栏顶部这里的 OpenSpecUI App，这里的icon改成我们的 logo"
 * Owner implementation (2026-08-03): track the hand-designed app-icon sources and their Deno generation script.
 */
