...
Registry adoption (2026-09-06): PressButton comes from @jixoai (variant ladder
fill/tonal — "primary"→fill, the copied transient→tonal+jx-hue-success);
entrances are the registry scroll-driven [data-reveal] CSS (static markup,
the IO action retired).
-->
<script lang="ts">
...
<section class="mx-auto w-full max-w-[90rem] px-4 pb-10 pt-10 sm:px-6 sm:pt-14 lg:px-8">
  ...
  >
    ...
    <div class="min-w-0" data-reveal="" style="--reveal-rise: 12px">
      <TerminalCard
