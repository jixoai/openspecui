 ...
 * 1. Own browser/PWA relay launch sources for the complete App route lifetime.
 ...
 * 5. Preserve launch configuration errors for the Workspaces presentation surface.
 *
