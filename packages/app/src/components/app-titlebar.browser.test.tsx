 ...
 * 2. Prove the narrow App chrome remains page-contained without horizontal overflow.
 *
...
describe('AppTitlebar browser boundary', () => {
  it('keeps a self-drawn OpenTray titlebar above Workspace tabs at narrow width', async () => {
