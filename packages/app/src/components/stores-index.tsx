 ...
 * 3. Pure presentation: direct Store id/health/usage/mutation state; secondary evidence collapsed.
 *
 ...
 */
export function StoresIndex({ rows, environmentLabel, envUri, onOpenDetail }: StoresIndexProps) {
