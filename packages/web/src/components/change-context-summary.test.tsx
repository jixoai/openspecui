 ...
 * 1. Prove compact Change scan facts stay in the default decision region.
...
import { ChangeContextSummary, type ChangeReferenceEvidence } from './change-context-summary'
