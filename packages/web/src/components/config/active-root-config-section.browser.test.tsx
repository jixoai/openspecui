 ...
 * 1. Exercise Structured and Raw Active Root mode-local drafts in real narrow Chromium layout.
 * 2. Prove the Config owner remains horizontally contained while shared-Store impact stays visible.
...
const { activeRootSubscriptionMock } = vi.hoisted(() => ({
