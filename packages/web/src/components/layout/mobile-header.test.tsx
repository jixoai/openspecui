...
describe('MobileHeader', () => {
  ...
  it('places notifications next to search and renders live status as icon-only', () => {
    ...
    expect(searchButton.className).toContain('top-layer-entry-button')
    ...
    expect(searchButton.className).toContain('p-0')
    expect(notificationButton.className).toContain('p-0')
    expect(searchButton.className).not.toContain('px-2')
