...
Define the live, backend-authoritative web-notifications platform, including grouped in-app notifications, browser notification bridging, notification actions, sound settings, and local publish APIs.
