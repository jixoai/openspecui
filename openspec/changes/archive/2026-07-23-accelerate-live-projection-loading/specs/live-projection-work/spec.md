...
1. Define the server-owned identity and sharing boundary for live projection work.
2. Preserve snapshot freshness, provenance, cancellation, and mutation authority through root transitions.
3. Require observable partial delivery without inventing a second client-side fact source.
4. Bound resource use and protect demand-driven work from optional warmup.
