...
1. Advance the Agent delivery inventory requirement to the OpenSpecUI 13 line.
2. Record that 1.13 carries forward every 1.12 physical fact with no new tool entries.
...
- FROM: `### Requirement: OpenSpecUI 12 Agent Delivery Inventory`
- TO: `### Requirement: OpenSpecUI 13 Agent Delivery Inventory`
